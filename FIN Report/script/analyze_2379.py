...
def main():
    base_dir = r"c:\Users\Philip Wu\Documents\FIN Report\2379"
    script_dir = os.path.dirname(os.path.abspath(__file__))
    output_file = os.path.join(base_dir, "Analysis_2379_2025_FullYear.md")
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        f.write("# Financial Analysis for Realtek (2379) - 2025 Full Year\n\n")

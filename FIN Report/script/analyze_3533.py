...
def main():
    base_dir = r"c:\Users\Philip Wu\Documents\FIN Report\3533"
    script_dir = os.path.dirname(os.path.abspath(__file__))
    output_file = os.path.join(base_dir, "Analysis_3533_2025_FullYear.md")
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        f.write("# Financial Analysis for Lotes (3533) - 2025 Full Year\n\n")

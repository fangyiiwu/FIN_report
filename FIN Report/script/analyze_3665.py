...
def main():
    base_dir = r"c:\Users\Philip Wu\Documents\FIN Report\3665"
    script_dir = os.path.dirname(os.path.abspath(__file__))
    output_file = os.path.join(base_dir, "Analysis_3665_2025_FullYear.md")
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        f.write("# Financial Analysis for BizLink (3665) - 2025 Full Year\n\n")
